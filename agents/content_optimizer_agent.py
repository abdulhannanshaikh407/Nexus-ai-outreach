...
class ContentOptimizerAgent:
    ...
    def __init__(self, llm_model: str = "gpt-3.5-turbo", temperature: float = 0.3):
        ...
        self.readability_chain = ChatPromptTemplate.from_messages([
            ("system", "{system_prompt}"),
            ("human", "{user_input}")
        ]) | self.llm | StrOutputParser()

        self.cta_chain = ChatPromptTemplate.from_messages([
            ("system", "{system_prompt}"),
            ("human", "{user_input}")
        ]) | self.llm | StrOutputParser()
    ...
    def _optimize_content_wrapper(self, query: str) -> str:
        ...
        try:
            ...
            return self.content_chain.invoke({
    ...
    def _analyze_readability_wrapper(self, query: str) -> str:
        ...
        try:
            ...
            return self.readability_chain.invoke({
                "system_prompt": prompt,
                "user_input": body
            })
        except Exception as e:
